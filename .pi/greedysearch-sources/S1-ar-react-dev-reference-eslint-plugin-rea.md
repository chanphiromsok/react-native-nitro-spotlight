---
url: https://ar.react.dev/reference/eslint-plugin-react-hooks/lints/refs
title: refs – React
source: http
status: 200
chars: 3254
...
Validates correct usage of refs, not reading/writing during render. See the “pitfalls” section in [`useRef()` usage](https://ar.react.dev/reference/react/useRef#usage).

 ...
 * SpotlightTooltip is intentionally zero-animation — it positions itself but does
 * not fade, slide, or spring. Add your own animation by wrapping it in a
 * Reanimated Animated.View or React Native's Animated API. See README for examples.
 *
 * @example
 * ```tsx
